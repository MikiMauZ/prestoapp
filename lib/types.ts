...
// Reminders
export type ReminderFrequency = 'DIARIO' | 'SEMANAL' | 'MENSUAL' | 'PUNTUAL' | 'FECHA_ESPECIFICA' | 'TEMPORIZADOR';
...
export interface Reminder {
  ...
  timerTargetAt?: any; // Timestamp
  timerDurationMinutes?: number; // Guardar duración original
  lastCompletedAt?: any;
  isActive: boolean;
  createdAt: any;
}
