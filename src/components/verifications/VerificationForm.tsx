...
type InstrumentType = 'PHOTOMETER' | 'TURBIDIMETER';
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-none shadow-xl">
        <CardHeader className="bg-primary text-white rounded-t-lg">
          <div className="flex justify-between items-center">
            <div>
              ...
              <CardDescription className="text-white/70">Comparación de Kits de Referencia Certificados vs Equipo Digital</CardDescription>
            </div>
        ...
        <CardContent className="pt-8 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-3">
              <Label htmlFor="instrument" className="text-sm font-semibold uppercase tracking-wider text-muted-foreground">Equipo a Verificar</Label>
              <Select value={instrument} onValueChange={(v) => setInstrument(v as InstrumentType)}>
                <SelectTrigger id="instrument" className="h-12 text-lg">
                  <SelectValue placeholder="Seleccionar instrumento" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="PHOTOMETER">Fotómetro Digital (Cloro/pH)</SelectItem>
                  <SelectItem value="TURBIDIMETER">Turbidímetro (Turbidez)</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="space-y-3">
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-bold flex items-center gap-2 border-b pb-2">
              ...
              Protocolo de Verificación por Puntos
            </h3>
        ...
        <CardFooter className="bg-slate-100/50 p-8 flex flex-col items-stretch gap-6 rounded-b-lg">
          <Alert variant="destructive" className="bg-red-50 border-red-200">
            <AlertTriangle className="w-5 h-5" />
            <AlertTitle className="font-bold text-red-900 uppercase">Declaración Jurada de Verificación</AlertTitle>
            <AlertDescription className="text-red-700 text-xs mt-1 font-medium leading-relaxed">
              Al firmar este documento, certifico que las lecturas y fotos corresponden a patrones reales trazables. 
              Este registro quedará bloqueado y servirá como prueba de cumplimiento normativo ante inspecciones sanitarias.
            </AlertDescription>
          </Alert>
