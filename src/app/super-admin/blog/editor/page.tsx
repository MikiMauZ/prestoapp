          ...
          <div className="space-y-6 overflow-y-auto pr-2">
            <div className="p-6 bg-slate-900/50 rounded-2xl border border-slate-800 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input value={title} onChange={e => setTitle(e.target.value)} className="bg-slate-950 border-slate-700" placeholder="Ej: Nueva Normativa RD 3/2023" />
              </div>

              <div className="space-y-2">
                <Label className="text-[10px] font-bold text-slate-500 uppercase">Imagen Destacada (URL)</Label>
                <Input value={featuredImage} onChange={e => setFeaturedImage(e.target.value)} className="bg-slate-950 border-slate-700" placeholder="https://..." />
              ...
              <div className="space-y-2">
                ...
                <Textarea value={excerpt} onChange={e => setExcerpt(e.target.value)} className="bg-slate-950 border-slate-700 text-xs" rows={4} placeholder="Breve descripción para la cuadrícula..." />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input value={tags} onChange={e => setTags(e.target.value)} className="bg-slate-950 border-slate-700" placeholder="normativa, piscinas, tech" />
              </div>
            </div>
